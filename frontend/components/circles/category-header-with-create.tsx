...
export function CategoryHeaderWithCreate({ title, tabs }: { title: string; tabs: TabItem[] }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${environment.BACKEND_ENDPOINT}/circles`, {
        method: 'POST',
        headers: {
                      ...
                      <div className="h-0 flex-1 overflow-y-auto">
                        <div className="bg-indigo-700 px-4 py-6 sm:px-6">
                          <div className="flex items-center justify-between">
                            <Dialog.Title className="text-base font-semibold leading-6 text-white">サークルの作成</Dialog.Title>
                          ...
                          <div className="mt-1">
                            <p className="text-sm text-indigo-300"> 新たなサークルを作成して、情報の共有を始めましょう</p>
                          </div>
                        </div>
                        <div className="flex flex-1 flex-col justify-between">
                          <div className="divide-y divide-gray-200 px-4 sm:px-6">
                            <div className="space-y-6 pb-5 pt-6">
                              <div>
                                <label htmlFor="circle-handle" className="block text-sm font-medium leading-6 text-gray-900">
                                  サークルのURL
                                </label>
                                <div className="mt-2">
                              ...
                              <div>
                                <label htmlFor="circle-name" className="block text-sm font-medium leading-6 text-gray-900">
                                  サークル名
                                </label>
                                <div className="mt-2">
                                  <input
