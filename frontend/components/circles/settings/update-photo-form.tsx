...
export function UpdatePhotoForm({ circleId }: { circleId: string }) {
  ...
  const handleSelected = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${environment.BACKEND_ENDPOINT}/circles/${circleId}/photo`, {
        method: 'POST',
        headers: {
