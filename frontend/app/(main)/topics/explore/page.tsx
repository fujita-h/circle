...
const tabItems: TabItem[] = [
  { name: 'Weekly', href: '/topics/explore', current: false },
  { name: 'Monthly', href: '/topics/explore?tab=monthly', current: false },
];
          ...
          <div className="p-4 md:p-8">
            <div className="px-4">
              ...
              <div className="mt-6 ml-1">
                ...
                <p className="text-base text-gray-500">注目されているトピック</p>
              </div>
              <div className="mt-6">
